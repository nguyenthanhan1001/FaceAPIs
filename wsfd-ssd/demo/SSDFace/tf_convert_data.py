...
from datasets import face_to_tfrecords
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'facescrub' or FLAGS.dataset_name == 'aflw':
        face_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
