...
class _PersonDetection(object):
    ...
    def load(self, net_shape=(300, 300), data_format='NHWC', ckpt_filename=config.PERSON_MODEL):
...
class FaceDetection(object):
    ...
    def load(self, net_shape=(300, 300), data_format='NHWC', ckpt_filename=config.FACE_MODEL):
        xtime = time.time()
